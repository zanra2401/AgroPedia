...
- setelah mendownload extract lalu buka folder dan jalankan index.html di browser jika anda meclone repo ini tinggal pindah directory ke folder hasil clone dan buka index.html di browser
